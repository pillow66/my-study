...
!function () {
  ...
  var o = function (e) {
    ...
    zoomTo: function (e, o, _, t, l) {
      ...
      var r = (_ + i.__scrollLeft) * e / n - _, a = (t + i.__scrollTop) * e / n - t;
    ...
    doTouchMove: function (e, o, _) {
      ...
      if (t.__isTracking) {
        ...
        var n = t.__positions;
        if (t.__isDragging) {
          var r = l - t.__lastTouchLeft, a = i - t.__lastTouchTop, c = t.__scrollLeft, s = t.__scrollTop,
            p = t.__zoomLevel;
          if (null != _ && t.options.zooming) {
            var h = p;
            if (p = p / t.__lastScale * _, p = Math.max(Math.min(p, t.options.maxZoom), t.options.minZoom), h !== p) {
              var f = l - t.__clientLeft, m = i - t.__clientTop;
          ...
          var v = t.options.locking ? 3 : 0, T = 5, d = Math.abs(l - t.__initialTouchLeft),
    ...
    doTouchEnd: function (e) {
      ...
      var o = this;
      if (o.__isTracking) {
        if (o.__isTracking = !1, o.__isDragging) if (o.__isDragging = !1, o.__isSingleTouch && o.options.animating && e - o.__lastTouchMove <= 100) {
          for (var _ = o.__positions, t = _.length - 1, l = t, i = t; i > 0 && _[i] > o.__lastTouchMove - 100; i -= 3) l = i;
          if (l !== t) {
            var n = _[t] - _[l], r = o.__scrollLeft - _[l - 2], a = o.__scrollTop - _[l - 1];
    ...
    __publish: function (e, t, l, i) {
      ...
      if (r && (core.effect.Animate.stop(r), n.__isAnimating = !1), i && n.options.animating) {
        ...
        var a = n.__scrollLeft, c = n.__scrollTop, s = n.__zoomLevel, p = e - a, h = t - c, f = l - s,
          m = function (e, o, _) {
    ...
    __startDeceleration: function (e) {
      ...
      if (o.options.paging) {
        var _ = Math.max(Math.min(o.__scrollLeft, o.__maxScrollLeft), 0),
          t = Math.max(Math.min(o.__scrollTop, o.__maxScrollTop), 0), l = o.__clientWidth, i = o.__clientHeight;
      ...
      }, r = o.options.snapping ? 4 : .001, a = function () {
    ...
    __stepThroughDeceleration: function (e) {
      var o = this, _ = o.__scrollLeft + o.__decelerationVelocityX, t = o.__scrollTop + o.__decelerationVelocityY;
      ...
      if (o.options.bouncing) {
        var r = 0, a = 0, c = o.options.penetrationDeceleration, s = o.options.penetrationAcceleration;
